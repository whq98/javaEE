...
<body>
	<form method="post"
		action="<%=basePath%>SendController?methodName=PLDelete">
					...
					<tr>
						...
						<td><div class="button-group">
								<a class="button border-blue"
									...
									class="icon-trash-o"></span> 查看</a> <a class="button border-red"
									href="<%=basePath%>SendController?methodName=deleteMail&user_name=${USER.login_name}&mail_id=${mail.email_id }"
